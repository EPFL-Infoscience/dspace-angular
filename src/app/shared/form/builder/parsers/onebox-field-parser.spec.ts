...
describe('OneboxFieldParser test suite', () => {
  ...
  it('should init parser properly', () => {
    const parser = new OneboxFieldParser(submissionId, field1, initFormValues, parserOptions, null, null);
  ...
  it('should return a DynamicQualdropModel object when selectableMetadata is multiple', () => {
    const parser = new OneboxFieldParser(submissionId, field2, initFormValues, parserOptions, null, null);
  ...
  it('should return a DsDynamicInputModel object when selectableMetadata is not multiple', () => {
    const parser = new OneboxFieldParser(submissionId, field3, initFormValues, parserOptions, null, null);
  ...
  describe('should handle a DynamicOneboxModel with regex', () => {
    ...
    beforeEach(() => {
      ...
      parser = new OneboxFieldParser(submissionId, regexField, initFormValues, parserOptions, null, null);
