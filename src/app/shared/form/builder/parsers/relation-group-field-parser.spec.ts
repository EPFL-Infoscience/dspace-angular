...
describe('RelationGroupFieldParser test suite', () => {
  ...
  it('should init parser properly', () => {
    const parser = new RelationGroupFieldParser(submissionId, field, initFormValues, parserOptions, null, null);
  ...
  it('should return a DynamicRelationGroupModel object when has a inline group', () => {
    ...
    const parser = new RelationGroupFieldParser(submissionId, inLineField, initFormValues, parserOptions, null, null);
