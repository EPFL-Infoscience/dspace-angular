...
export class AdminSidebarComponent extends MenuComponent implements OnInit {
  ...
  createExportMenuSections() {
    ...
    observableCombineLatest(
      ...
      take(1)
    ).subscribe(([authorized, metadataExportScriptExists]: boolean[])  => {
      ...
      this.menuService.addSection(this.menuID, {
        id: 'export',
        active: (authorized || metadataExportScriptExists),
      ...
      this.menuService.addSection(this.menuID, {
        id: 'export_metadata',
        parentID: 'export',
        active: metadataExportScriptExists,
        visible: metadataExportScriptExists,
        model: {
          type: MenuItemType.ONCLICK,
  ...
  createImportMenuSections() {
    ...
    observableCombineLatest(
      ...
      take(1)
    ).subscribe(([authorized, metadataImportScriptExists]: boolean[]) => {
      // Hides the import menu for unauthorised people
      // If in the future more sub-menus are added,
      // it should be reviewed if they need to be in this subscribe
      this.menuService.addSection(this.menuID, {
        id: 'import',
        active: (authorized || metadataImportScriptExists),
      ...
      this.menuService.addSection(this.menuID, {
        id: 'import_metadata',
        parentID: 'import',
        active: metadataImportScriptExists,
        visible: metadataImportScriptExists,
        model: {
          type: MenuItemType.LINK,
