...
export class DeduplicationSetsEffects {
   ...
   */
  retrieveAllSetsErrorAction$ = createEffect(() => this.actions$.pipe(
  ...
  removeSetsAction$ = createEffect(() => this.actions$.pipe(
  ...
  removeItemPerSetAction$ = createEffect(() => this.actions$.pipe(
