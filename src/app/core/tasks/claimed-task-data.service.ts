...
export class ClaimedTaskDataService extends TasksService<ClaimedTask> {
   ...
   *    The server response
   */
  public findByItem(uuid: string, options: FindListOptions = {}, ...linksToFollow: FollowLinkConfig<ClaimedTask>[]): Observable<RemoteData<ClaimedTask>> {
    const findOptions = Object.assign(new FindListOptions(), options);
