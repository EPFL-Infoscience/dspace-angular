...
export const GroupRoles: GroupRole[] = [
  ...
  {
    title: 'edit a published publication/patent/dataset by requesting a correction (subject to workflow approval), correction requester and curators are notified.',
    anonymous: 'N',
    authenticatedUser: 'N',
    submitter: 'N',
    curator: 'Y',
  ...
  {
    title: 'delete an existing version',
    anonymous: 'N',
    authenticatedUser: 'N',
    submitter: 'N',
    curator: 'Y',
